     ...
     <div className={styles.rbox}>
      <Row style={{left:"50px;"}}>
        <Col xs={{ span: 5, offset: 5 }} lg={{ span: 6, offset: 2 }} >
          { UserID=='admin'?
            <div onClick={()=>movePage("/customerInfos")} className={styles.box_3}>
              <img className={styles.img} src="/assets/MainPage/img4.png" />
            ...
            <div onClick={()=>movePage("/introService")} className={styles.box_3}>
        ...
        <Col xs={{ span: 5, offset: 5 }} lg={{ span: 6, offset: 2 }} >
          { !UserID ? 
            <div onClick={() => alert('로그인이 필요한 서비스입니다!')} className={styles.box_3}>
            ...
            ( UserID=='admin'?
            <div onClick={()=>movePage("/monitoring")} className={styles.box_3}>
              <img className={styles.img} src="/assets/MainPage/img2.png" />
            ...
            <div onClick={()=>movePage("/reservationPage")} className={styles.box_3}>
              <img className={styles.img} src="/assets/MainPage/img2.png" />
              <center className={styles.text2}>주차 예약</center>
              <center className={styles.text3}>원활한 주차장 이용을 위해<br></br>미리 예약을 진행합니다.</center>
            </div>
        ...
        <Col xs={{ span: 5, offset: 5 }} lg={{ span: 6, offset: 2 }} >
          ...
          ( UserID=='admin'?
          <div onClick={()=>movePage("/statistics")} className={styles.box_3}>
            <img className={styles.img} src="/assets/MainPage/img5.png" />
            <div className={styles.text2}>주차장 사용 통계</div>
            <center className={styles.text3}>주차장 사용 통계 확인이 <br></br> 가능합니다.</center>
          </div>:
          <div onClick={()=>movePage("/checkReservation")} className={styles.box_3}>
            <img className={styles.img} src="/assets/MainPage/img3.png"/>
            <center className={styles.text2}>예약 내역</center>
            <center className={styles.text3}>가입된 회원의 예약 내역<br></br> 확인이 가능합니다.</center>
          </div>
