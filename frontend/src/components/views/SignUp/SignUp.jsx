  ...
  return (
    <>
      ...
      >
        ...
        >
          <Input placeholder="Write 4 to 12 numbers and alphabet." />
        </Form.Item>
        ...
        >
          <Input.Password placeholder="Write 4 to 12 numbers and alphabet." />
        </Form.Item>
        ...
        >
          <Input.Password placeholder="Check if the password is the same." />
        </Form.Item>
        ...
        >
          <Input placeholder="Write your Car Number." />
        </Form.Item>
