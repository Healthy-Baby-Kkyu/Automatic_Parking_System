            ...
            <div className={styles.rs}>
                ...
                <Form
                    ...
                    <div className={styles.charge_main}>
                        ...
                        <div style={{ display: "flex", float: "right", marginTop: "5px", marginRight: "20px" }}>
                            {count % 2 == "0" && (
                                <>
                                    <Button style={{ marginLeft: "4px" }} size="small" onClick={() => setPoint(point + 1000)}>+1000</Button>
                                    <Button style={{ marginLeft: "4px" }} size="small" onClick={() => setPoint(point + 5000)}>+5000</Button>
                                    <Button style={{ marginLeft: "4px" }} size="small" onClick={() => setPoint(point + 10000)}>+10000</Button>
                                    <Button style={{ marginLeft: "4px" }} size="small" onClick={() => setPoint(point + 50000)}>+50000</Button>
                                </>
                            )}
                            {count % 2 == "1" && (
                                <>
                                    <Button style={{ marginLeft: "4px" }} size="small" onClick={() => setPoint(point + 1000)} disabled>+1000</Button>
                                    <Button style={{ marginLeft: "4px" }} size="small" onClick={() => setPoint(point + 5000)} disabled>+5000</Button>
                                    <Button style={{ marginLeft: "4px" }} size="small" onClick={() => setPoint(point + 10000)} disabled>+10000</Button>
                                    <Button style={{ marginLeft: "4px" }} size="small" onClick={() => setPoint(point + 50000)} disabled>+50000</Button>
                                </>
                            )}
                        ...
                        <div style={{ borderTop: "1px solid #D9D9D9", marginTop: "50px", paddingTop: "10px" }} className={styles.charge_inside}>
                            <div style={{ flex: "1", textAlign: "right", paddingRight: "255px", marginTop: "17px" }}>충전 후 포인트 :</div>
                            <Form.Item style={{ marginRight: "10px" }}>
                                <Input name="point" style={{ marginTop: "10px", marginLeft: "-70px", marginRight: "80px", textAlign: "right", flex: "1", color: "#0F31FF", fontWeight: "bold", fontSize: "20px" }}
                                    type="number"
                                    placeholder="0"
